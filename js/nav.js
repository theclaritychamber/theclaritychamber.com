(function () {
  ...
  if (document.getElementById("booking-form")) {
    ...
    if (!document.getElementById("fix-booking-css")) {
      var style = document.createElement("style");
      style.id = "fix-booking-css";
      style.textContent =
        ".is-invalid{border-color:#a33 !important;box-shadow:0 0 0 3px rgba(170,51,51,0.18) !important;}" +
        "#form-status{display:block;margin:0.8rem 0 0;font-size:0.95rem;}";
  ...
  style.textContent =
    ...
    ".live-fields .is-invalid,#booking-date.is-invalid,#platform.is-invalid,#booking-time.is-invalid{border-color:#a33 !important;}";
  document.head.appendChild(style);
})();
